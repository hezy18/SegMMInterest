...
class CANBase(DIENBase):
	...
	def forward(self, feed_dict):
		...
		item_ids_induce = self.item_embedding_induce(item_ids) # bsz, n_item, induce_vec_size=512
		user_ids_emb = self.embedding_dict['user_id'](user_ids) # bsz, vec_size=64
		item_his_emb = self.embedding_dict['item_id'](history_item_ids) # bsz, his_len=20, vec_size=64
		...
		# print('ui_coaction',ui_coaction.shape) # bsz,n_item, 8
		# print('his_coaction',his_coaction.shape) # bsz,n_item, 8
		# print('dien_inp',dien_inp.shape) # bsz,n_item, 576
