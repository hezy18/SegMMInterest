...
class WideDeepBase(FMBase):
	...
	def parse_model_args_WD(parser):
		...
		parser.add_argument('--layers', type=str, default='[64]',
							help="Size of each layer.") # TODO: 注意这不是dnn layers
		return parser
	...
	def _define_params_WD(self):
		...
		pre_size = (len(self.context_features) + self.item_frame_number) * self.vec_size
		# deep layers
...
class WideDeepRanking(ContextModel,WideDeepBase):
