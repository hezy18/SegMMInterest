...
from models.context.WideDeep import WideDeepCTR, WideDeepRanking
...
class DeepFMRanking(WideDeepRanking, DeepFMBase):
	reader, runner = 'ContextReader','BaseRunner'
	extra_log_args = ['emb_size','layers','loss_n']

	def __init__(self, args, corpus):
		WideDeepRanking.__init__(self, args, corpus)
