...
class GCN(torch.nn.Module):
    ...
    def forward(self, features, id_embedding):
        ...
        if features.shape[-1]==1025:
            x_hat[-pos_embedding.shape[0]:] = x_hat[-pos_embedding.shape[0]:] + pos_embedding  
