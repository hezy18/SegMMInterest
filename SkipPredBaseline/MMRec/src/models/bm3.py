...
class BM3(GeneralRecommender):
    def __init__(self, config, dataset):
        ...
        # nn.init.xavier_uniform_(self.new_pos_embedding.weight)
    ...
    def forward(self):
        ...
        if self.v_feat is not None and self.v_feat.shape[-1]==1025:
            ...
            # print('self.item_id_embedding.weight',self.item_id_embedding.weight.min(),self.item_id_embedding.weight.max())
