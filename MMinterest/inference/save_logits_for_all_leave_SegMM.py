...
if __name__=="__main__":
    ...
    if args.test_exposure_prob_type=='statistics':
        with open("SegMM/SegMM_ExposureProb.json", "r") as f:
            probs = json.load(f)
            for idx in probs:
    ...
    ckpt_list =[
        'ckpts_SegMM/6_ones_0.001_0.0001_1_interestBPR_1.0_both_both_0_1_2_earlystop_focal/ckpt-latest-*.pth',
        'ckpts_SegMM/6_ones_0.001_0.0001_1_interestBPR_1.0_both_both_0_1_-3_earlystop_focal/ckpt-latest-*.pth',
        'ckpts_SegMM/6_ones_0.001_0.0001_0_interestBPR_1.0_both_both_0_1_-3_earlystop_focal/ckpt-latest-*.pth',
        'ckpts_SegMM/6_ones_0.001_0.0001_1_interestBPR_1.0_both_both_0_1_0_earlystop_focal/ckpt-latest-*.pth'
    ]
    print(ckpt_list)
    print(len(ckpt_list))
    # import pdb; pdb.set_trace()
    ...
    for ckpt_path in ckpt_list:
        ...
        args.fusion_heads = int(ckpt_dir.split('_')[-3])
